...
%
% APEX Iridium with SBE83 (doxy), ISUS (nitrate), DURA (ph), FLBB (chla & bb)
%
% 5 B-Argo parameters: DOXY, CHLA, BBP700, PH_IN_SITU_TOTAL, NITRATE
%
% 11 I-Argo parameters: PHASE_DELAY_DOXY, TEMP_DOXY, FLUORESCENCE_CHLA, BETA_BACKSCATTERING700, VRS_PH, IB_PH, IK_PH, VK_PH PH_IN_SITU_FREE, UV_INTENSITY_PARK_NITRATE, UV_INTENSITY_NITRATE (spectral)
%
% N_PARAM = 16 + 1 (PRES) = 17
%
%
...
station_params=...
    ...
    pres64, tempdoxy64, phasedelaydoxy64, doxy64, fluorescence64, chla64, backscattering64, bbp64, vrsph64, ibph64, ikph64, vkph64, phfree64, phtotal64, uvdarknitrate64, uvnitrate64, nitrate64];
...
clear junk64 junkpres junktempdoxy junkphasedoxy junkdoxy junkfluorescence junkchla junkbackscattering junkbbp junkvrsph junkibph junkikph junkvkph junkphfree junkphtotal junkuvdarknitrate junkuvnitrate junknitrate
...
param_datamode=...
    ['R', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ';
    'R', 'R', 'R', doxydatamode, 'R', chladatamode, 'R', bbpdatamode, 'R', 'R', 'R', 'R', 'R', phdatamode, 'R', 'R', nidatamode];
...
phasedelay_doxy=LR.PHASE_DELAY_DOXY;
ii=find(phasedelay_doxy>99998);
phasedelay_doxy(ii)=fillfloat;
varid=netcdf.inqVarID(fid,'PHASE_DELAY_DOXY');
netcdf.putVar(fid, varid, [0 1], [nlowres 1], phasedelay_doxy);

phasedelay_doxy_qc=num2str(zeros(nlowres,1));
phasedelay_doxy_qc(ii)='9';
varid=netcdf.inqVarID(fid,'PHASE_DELAY_DOXY_QC');
netcdf.putVar(fid, varid, [0 1], [nlowres 1], phasedelay_doxy_qc);
...
netcdf.putVar(fid, varid, [0,17-1,0,1], [256,1,1,1], ni_eqn256); %nitrate=17
