...
%
% APEX Iridium with Aanderaa 4330 (doxy), ISUS (nitrate)
%
% 2 B-Argo parameters: DOXY, NITRATE
%
% 4 I-Argo parameters: TEMP_DOXY, TPHASE_DOXY, UV_INTENSITY_PARK_NITRATE, UV_INTENSITY_NITRATE (spectral)
%
% N_PARAM = 6 + 1 (PRES) = 7
%
%
...
pres64, tempdoxy64, tphasedoxy64, doxy64, uvdarknitrate64, uvnitrate64, nitrate64];
...
clear junk64 junkpres junktempdoxy junktphasedoxy junkdoxy junkuvdarknitrate junkuvnitrate junknitrate
