...
%
% APEX Iridium with Aanderaa 3830 (doxy), ISUS (nitrate), FLBB (chla & bb)
%
% 4 B-Argo parameters: DOXY, CHLA, BBP700, NITRATE
%
% 6 I-Argo parameters: BPHASE_DOXY, TEMP_DOXY, FLUORESCENCE_CHLA, BETA_BACKSCATTERING700, UV_INTENSITY_DARK_NITRATE, UV_INTENSITY_NITRATE (spectral)
%
...
varid=netcdf.defVar(ncid,'PROFILE_BPHASE_DOXY_QC','NC_CHAR',[nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','Global quality flag of BPHASE_DOXY profile');
netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2a');
netcdf.putAtt(ncid,varid,'_FillValue',' ');
...
varid=netcdf.defVar(ncid,'BPHASE_DOXY','NC_FLOAT',[nlevels_dimid, nprof_dimid]);
...
varid=netcdf.defVar(ncid,'BPHASE_DOXY_QC','NC_CHAR',[nlevels_dimid, nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','quality flag');
netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2');
netcdf.putAtt(ncid,varid,'_FillValue',' ');
