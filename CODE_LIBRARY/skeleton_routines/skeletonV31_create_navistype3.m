...
%
% 11 I-Argo parameters: PHASE_DELAY_DOXY, TEMP_VOLTAGE_DOXY, TEMP_DOXY, FLUORESCENCE_CHLA, BETA_BACKSCATTERING700, BETA_BACKSCATTERING532, VRS_PH, TEMP_PH, PH_IN_SITU_FREE, UV_INTENSITY_DARK_NITRATE, UV_INTENSITY_NITRATE (spectral)
%
...
nparam_dimid=netcdf.defDim(ncid,'N_PARAM',15);
...
varid=netcdf.defVar(ncid,'PROFILE_BETA_BACKSCATTERING532_QC','NC_CHAR',[nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','Global quality flag of BETA_BACKSCATTERING532 profile');
netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2a');
netcdf.putAtt(ncid,varid,'_FillValue',' ');

varid=netcdf.defVar(ncid,'PROFILE_BBP532_QC','NC_CHAR',[nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','Global quality flag of BBP532 profile');
netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2a');
netcdf.putAtt(ncid,varid,'_FillValue',' ');
...
netcdf.putAtt(ncid,varid,'FORTRAN_format','F.6f');
netcdf.putAtt(ncid,varid,'_FillValue',single(99999.));
...
varid=netcdf.defVar(ncid,'BETA_BACKSCATTERING532','NC_FLOAT',[nlevels_dimid, nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','Total angle specific volume from backscattering sensor at 532 nanometers');
netcdf.putAtt(ncid,varid,'units','count');
netcdf.putAtt(ncid,varid,'resolution',single(0.0));
netcdf.putAtt(ncid,varid,'C_format','%.0f');
netcdf.putAtt(ncid,varid,'FORTRAN_format','F.0f');
...
varid=netcdf.defVar(ncid,'BETA_BACKSCATTERING532_QC','NC_CHAR',[nlevels_dimid, nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','quality flag');
netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2');
netcdf.putAtt(ncid,varid,'_FillValue',' ');

varid=netcdf.defVar(ncid,'BBP532','NC_FLOAT',[nlevels_dimid, nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','Particle backscattering at 532 nanometers');
netcdf.putAtt(ncid,varid,'units','m-1');
netcdf.putAtt(ncid,varid,'resolution',single(0.00001));
netcdf.putAtt(ncid,varid,'C_format','%.5f');
netcdf.putAtt(ncid,varid,'FORTRAN_format','F.5f');
...
varid=netcdf.defVar(ncid,'BBP532_QC','NC_CHAR',[nlevels_dimid, nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','quality flag');
netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2');
netcdf.putAtt(ncid,varid,'_FillValue',' ');

varid=netcdf.defVar(ncid,'BBP532_ADJUSTED','NC_FLOAT',[nlevels_dimid, nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','Particle backscattering at 532 nanometers');
netcdf.putAtt(ncid,varid,'units','m-1');
netcdf.putAtt(ncid,varid,'resolution',single(0.00001));
netcdf.putAtt(ncid,varid,'C_format','%.5f');
...
varid=netcdf.defVar(ncid,'BBP532_ADJUSTED_QC','NC_CHAR',[nlevels_dimid, nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','quality flag');
netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2');
netcdf.putAtt(ncid,varid,'_FillValue',' ');

varid=netcdf.defVar(ncid,'BBP532_ADJUSTED_ERROR','NC_FLOAT',[nlevels_dimid, nprof_dimid]);
netcdf.putAtt(ncid,varid,'long_name','Contains the error on the adjusted values as determined by the delayed mode QC process');
netcdf.putAtt(ncid,varid,'units','m-1');
netcdf.putAtt(ncid,varid,'resolution',single(0.00001));
netcdf.putAtt(ncid,varid,'C_format','%.5f');
