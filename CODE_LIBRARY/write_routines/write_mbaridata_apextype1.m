...
%
% 9 I-Argo parameters: TEMP_DOXY, TPHASE_DOXY, FLUORESCENCE_CHLA, BETA_BACKSCATTERING700, VRS_PH, IB_PH, PH_IN_SITU_FREE, UV_INTENSITY_PARK_NITRATE, UV_INTENSITY_NITRATE (spectral)
%
% N_PARAM = 14 + 1 (PRES) = 15
%
%
...
station_params=...
[pres64, junk64, junk64, junk64, junk64, junk64, junk64, junk64, junk64, junk64, junk64, junk64, junk64, junk64, junk64;
pres64, tempdoxy64, tphasedoxy64, doxy64, fluorescence64, chla64, backscattering64, bbp64, vrsph64, ibph64, phfree64, phtotal64, uvdarknitrate64, uvnitrate64, nitrate64];
...
clear junk64 junkpres junktempdoxy junktphasedoxy junkdoxy junkfluorescence junkchla junkbackscattering junkbbp junkvrsph junkibph junkphfree junkphtotal junkuvdarknitrate junkuvnitrate junknitrate
...
param_datamode=...
['R', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ';
'R', 'R', 'R', doxydatamode, 'R', chladatamode, 'R', bbpdatamode, 'R', 'R', 'R', phdatamode, 'R', 'R', nidatamode];
...
netcdf.putVar(fid, varid, [0,12-1,0,1], [256,1,1,1], ph_comment256); %ph=12
netcdf.putVar(fid, varid, [0,15-1,0,1], [256,1,1,1], ni_comment256); %nitrate=15
...
netcdf.putVar(fid, varid, [0,12-1,0,1], [256,1,1,1], ph_eqn256); %ph=12
netcdf.putVar(fid, varid, [0,15-1,0,1], [256,1,1,1], ni_eqn256); %nitrate=15
...
netcdf.putVar(fid, varid, [0,12-1,0,1], [256,1,1,1], ph_coeff256); %ph=12
netcdf.putVar(fid, varid, [0,15-1,0,1], [256,1,1,1], ni_coeff256); %nitrate=15
