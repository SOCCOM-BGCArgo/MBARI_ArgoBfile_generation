...
%
% APEX Iridium with Aanderaa 4330 (doxy), DURA (ph)
%
% 2 B-Argo parameters: DOXY, PH_IN_SITU_TOTAL
%
% 5 I-Argo parameters: TPHASE_DOXY, TEMP_DOXY, VRS_PH, PH_IN_SITU_FREE, IB_PH, IK_PH, VK_PH
%
% N_PARAM = 9 + 1 (PRES) = 10
%
%
...
nparam_dimid=netcdf.defDim(ncid,'N_PARAM',10);
