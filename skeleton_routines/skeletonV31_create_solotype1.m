...
% declare ocr-related variables.  Helps further down?  Although could
% simplify this further and only make wavelength dynamic...first just get
% it working with everything laid out!!  TM
% declare variables
