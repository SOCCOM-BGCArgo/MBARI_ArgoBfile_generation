...
nparam_dimid=netcdf.defDim(ncid,'N_PARAM',25);
...
%%% OK NOW INSERT SKELETON FOR ALL OF THE OCR VARIABLES!  WE WILL DO THIS IN LOOPS SO FIRST DECLARE VARIABLES.
%% 
% declare variables
...
for i2k = 1:length(IPARAMS)
    ...
    netcdf.putAtt(ncid,varid,'C_format','%10.0');
...
%%% OK NOW DONE INSERTING OCR PARAMETER SKELETON.  NOW DO SCIENTIFIC CALIB SECTION
% SCIENTIFIC_CALIB ------
