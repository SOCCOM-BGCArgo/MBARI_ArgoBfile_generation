...
%
% APEX Iridium with Aanderaa 4330 (doxy) only
%
% 1 B-Argo parameters: DOXY
%
% 2 I-Argo parameters: TPHASE_DOXY, TEMP_DOXY
%
% N_PARAM = 3 + 1 (PRES) = 4
%
%
% Tanya Maurer, April 2019 (modified from A. Wong's skeletonV31_create_apextype4.m)
%--------------------------------------------------------------
...
nparam_dimid=netcdf.defDim(ncid,'N_PARAM',4);
