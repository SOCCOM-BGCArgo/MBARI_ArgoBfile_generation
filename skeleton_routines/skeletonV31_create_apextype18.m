...
%
% APEX Iridium with Aanderaa 4330 (doxy), ISUS (nitrate), DURA (ph), FLBB2 (chla, chla435 & bb)
%
% 6 B-Argo parameters: DOXY, CHLA, CHLA435, BBP700, PH_IN_SITU_TOTAL, NITRATE
%
% 12 I-Argo parameters: TPHASE_DOXY, TEMP_DOXY, FLUORESCENCE_CHLA, FLUORESCENCE_CHLA435 BETA_BACKSCATTERING700, VRS_PH, PH_IN_SITU_FREE, IB_PH, IK_PH, VK_PH, UV_INTENSITY_DARK_NITRATE, UV_INTENSITY_NITRATE (spectral)
%
...
nparam_dimid=netcdf.defDim(ncid,'N_PARAM',17);
...
% varid=netcdf.defVar(ncid,'PROFILE_FLUORESCENCE_CHLA435_QC','NC_CHAR',[nprof_dimid]);
% netcdf.putAtt(ncid,varid,'long_name','Global quality flag of FLUORESCENCE_CHLA435 profile');
% netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2a');
% netcdf.putAtt(ncid,varid,'_FillValue',' ');
...
% varid=netcdf.defVar(ncid,'PROFILE_CHLA435_QC','NC_CHAR',[nprof_dimid]);
% netcdf.putAtt(ncid,varid,'long_name','Global quality flag of CHLA435 profile');
% netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2a');
% netcdf.putAtt(ncid,varid,'_FillValue',' ');
...
% varid=netcdf.defVar(ncid,'FLUORESCENCE_CHLA435','NC_FLOAT',[nlevels_dimid, nprof_dimid]);
% netcdf.putAtt(ncid,varid,'long_name','Chlorophyll-A signal at 435nm from fluorescence');
% netcdf.putAtt(ncid,varid,'units','count');
% netcdf.putAtt(ncid,varid,'resolution',single(0.0));
% netcdf.putAtt(ncid,varid,'C_format','%.0f');
% netcdf.putAtt(ncid,varid,'FORTRAN_format','F.0');
...
% varid=netcdf.defVar(ncid,'FLUORESCENCE_CHLA435_QC','NC_CHAR',[nlevels_dimid, nprof_dimid]);
% netcdf.putAtt(ncid,varid,'long_name','quality flag');
% netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2');
% netcdf.putAtt(ncid,varid,'_FillValue',' ');

% varid=netcdf.defVar(ncid,'CHLA435','NC_FLOAT',[nlevels_dimid, nprof_dimid]);
% netcdf.putAtt(ncid,varid,'long_name','Chlorophyll-A');
% netcdf.putAtt(ncid,varid,'standard_name','mass_concentration_of_chlorophyll_a_435nm_in_sea_water');
% netcdf.putAtt(ncid,varid,'units','mg/m3');
% netcdf.putAtt(ncid,varid,'resolution',single(0.0001));
% netcdf.putAtt(ncid,varid,'C_format','%.4f');
% netcdf.putAtt(ncid,varid,'FORTRAN_format','F.4');
...
% varid=netcdf.defVar(ncid,'CHLA435_QC','NC_CHAR',[nlevels_dimid, nprof_dimid]);
% netcdf.putAtt(ncid,varid,'long_name','quality flag');
% netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2');
% netcdf.putAtt(ncid,varid,'_FillValue',' ');

% varid=netcdf.defVar(ncid,'CHLA435_ADJUSTED','NC_FLOAT',[nlevels_dimid, nprof_dimid]);
% netcdf.putAtt(ncid,varid,'long_name','Chlorophyll-A');
% netcdf.putAtt(ncid,varid,'standard_name','mass_concentration_of_chlorophyll_a_435nm_in_sea_water');
% netcdf.putAtt(ncid,varid,'units','mg/m3');
% netcdf.putAtt(ncid,varid,'resolution',single(0.0001));
...
% varid=netcdf.defVar(ncid,'CHLA435_ADJUSTED_QC','NC_CHAR',[nlevels_dimid, nprof_dimid]);
% netcdf.putAtt(ncid,varid,'long_name','quality flag');
% netcdf.putAtt(ncid,varid,'conventions','Argo reference table 2');
% netcdf.putAtt(ncid,varid,'_FillValue',' ');

% varid=netcdf.defVar(ncid,'CHLA435_ADJUSTED_ERROR','NC_FLOAT',[nlevels_dimid, nprof_dimid]);
% netcdf.putAtt(ncid,varid,'long_name','Contains the error on the adjusted values as determined by the delayed mode QC process');
% netcdf.putAtt(ncid,varid,'units','mg/m3');
% netcdf.putAtt(ncid,varid,'resolution',single(0.0001));
% netcdf.putAtt(ncid,varid,'C_format','%.4f');
