...
%
% 11 I-Argo parameters: TPHASE_DOXY, TEMP_DOXY, FLUORESCENCE_CHLA, BETA_BACKSCATTERING700, VRS_PH, PH_IN_SITU_FREE, IB_PH, IK_PH, VK_PH, UV_INTENSITY_DARK_NITRATE, UV_INTENSITY_NITRATE (spectral)
%
% N_PARAM = 16 + 1 (PRES) = 17
%
%
% Annie Wong, February 2016
% Tanya Maurer, September 2021 added VK_PH and IK_PH, N_PARAM = 16+1(PRES) = 17
% Tanya Maurer, May 2024 added CHLA_FLUORESCENCE per Argo CHLA documentation (from Sept 2023);N_PARAM now = 18
%--------------------------------------------------------------
...
nparam_dimid=netcdf.defDim(ncid,'N_PARAM',18);
